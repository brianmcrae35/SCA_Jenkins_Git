...
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'C64ABA7B-3A3E-95B6-535D-3BC535DA5A59', 'SCHEMA', N'dbo', 'TABLE', N'ErrorLog', 'COLUMN', N'UserName'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'Credentials', 'SCHEMA', N'dbo', 'TABLE', N'ErrorLog', 'COLUMN', N'UserName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'331F0B13-76B5-2F1B-A77B-DEF5A73C73C2', 'SCHEMA', N'dbo', 'TABLE', N'ErrorLog', 'COLUMN', N'UserName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential', 'SCHEMA', N'dbo', 'TABLE', N'ErrorLog', 'COLUMN', N'UserName'
GO
