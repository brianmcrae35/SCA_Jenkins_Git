...
[SSN] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'57845286-7598-22F5-9659-15B24AEB125E', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'FirstName'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'Name', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'FirstName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'989ADC05-3F3F-0588-A635-F475B994915B', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'FirstName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential - GDPR', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'FirstName'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Last name of the person.', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'LastName'
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'57845286-7598-22F5-9659-15B24AEB125E', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'LastName'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'Name', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'LastName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'989ADC05-3F3F-0588-A635-F475B994915B', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'LastName'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential - GDPR', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'LastName'
GO
...
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'D936EC2C-04A4-9CF7-44C2-378A96456C61', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'SSN'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'SSN', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'SSN'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'989ADC05-3F3F-0588-A635-F475B994915B', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'SSN'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential - GDPR', 'SCHEMA', N'Person', 'TABLE', N'Person', 'COLUMN', N'SSN'
GO
