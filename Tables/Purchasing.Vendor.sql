...
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'C44193E1-0E58-4B2A-9001-F7D6E7BC1373', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'AccountNumber'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'Financial', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'AccountNumber'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'331F0B13-76B5-2F1B-A77B-DEF5A73C73C2', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'AccountNumber'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'AccountNumber'
GO
...
GO
EXEC sp_addextendedproperty N'sys_information_type_id', N'D22FA6E9-5EE4-3BDE-4C2B-A409604C4646', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'CreditRating'
GO
EXEC sp_addextendedproperty N'sys_information_type_name', N'Credit Card', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'CreditRating'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_id', N'331F0B13-76B5-2F1B-A77B-DEF5A73C73C2', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'CreditRating'
GO
EXEC sp_addextendedproperty N'sys_sensitivity_label_name', N'Confidential', 'SCHEMA', N'Purchasing', 'TABLE', N'Vendor', 'COLUMN', N'CreditRating'
GO
