CREATE TABLE [Person].[DMSSTAT_RSTATS]
(
...
[rulesource] [varchar] (250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ruletarget] [varchar] (250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_DMSSTAT_RSTATS] ON [Person].[DMSSTAT_RSTATS] ([runid], [ruleid]) ON [PRIMARY]
GO
